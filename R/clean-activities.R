...
cleanActivities <- function(activities, myGearList){
    ...
    if(!is.null(activities$message)) {
        ...
        start_latlng <- data.table::rbindlist(lapply(activities$start_latlng, as.data.frame.list))
        end_latlng <- data.table::rbindlist(lapply(activities$end_latlng, as.data.frame.list))
        map <- data.table::rbindlist(lapply(activities$map, as.data.frame.list))
